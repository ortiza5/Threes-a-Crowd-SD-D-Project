...
#Use this as a test file. If we modify the usertypes we should run this file for testing.
...
def Test2CreateDifferentUserTypes():
	...
	user4 = usertypes.User("Andy", "William", "Cisive", "cisiva@rpi.edu", "7188178181") #Get it? Andy Cisive? Indecisive? Yeah, that was a bad pun.
