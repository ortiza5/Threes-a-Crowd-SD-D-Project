# This file is used to define all of the User types
...
class User:
    ...
    # toString function
    def __str__(self):
        return self.getFirst() + " " + self.getMiddleInitial() + " " \
                + self.getLast()
...
# This would be a member of the school staff
# (i.e. a Registrar's office staff member)
